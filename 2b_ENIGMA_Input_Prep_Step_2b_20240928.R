...
###### Script 2a: Preparing ALSPAC-PE imaging dataset for brain age prediction using the ENIGMA model
###### Description: Caluclating averages and splitting dataset by sex 
