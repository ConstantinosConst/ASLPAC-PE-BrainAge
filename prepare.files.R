prepare.files=function(df,cov){
  #col_cov=c('Age','Sex','PE')
  col_cov=c('SubjID','Age','Sex','PE')
  ...
  # Age was not floored for the current sample (ALSPAC-PE) to preserve limited sample variation in age. 
  ...
  # NB. All successfully processed scans for the ALSPAC-PE sample have valid IDPs. Thus, NO median imputation was performed in this sample. 
